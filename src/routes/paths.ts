...
export const paths = {
  ...
  private:"/quyen-rieng-tu",
  casino:"/casino-k89bet",
  lottery:"/xo-so-k89bet",
  jackpot:"/no-hu-k89bet",
  pricing: '/pricing',
  payment: '/payment',
  about: '/gioi-thieu-k89bet',
  sports: "/the-thao/",
  promotion: "/huong-dan/khuyen-mai-k89bet",
  register: "/huong-dan/dang-ky-k89bet",
  ...
  page500: '/error/500',
  dowload:
    "https://www.hdk89bet.site/",
  login: "https://k89bet4.net",
  registerNow: "https://www.k89bet4.net/?uagt=seowed&path=signup",
  product: {
    root: `/product`,
