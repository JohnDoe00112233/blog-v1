...
export const metadata = {
  ...
  twitter: {
    ...
    url: `https://k89bet68.com/${paths.tutorial}/vi_VN`,
    images: [
      {
        url: `/assets/images/huong-dan-k89bet.webp`,
        alt: "Tất cả hướng dẫn chi tiết về K89Bet. Tìm hiểu cách đăng ký K89Bet, nạp tiền, rút tiền, tải app, và khám phá khuyến mãi K89Bet mới nhất.",
  ...
  alternates: {
    canonical: `https://k89bet68.com/${paths.tutorial}/vi_VN`,
    languages: {
      "vi-VN": `https://k89bet68.com/${paths.tutorial}/vi_VN`,
    }
  },
};
...
const jsonLd = {
  ...
  "url": `https://k89bet68.com/${paths.tutorial}`,
  "mainEntity": {
    "@type": "ItemList",
    "itemListElement": [
      {
        ...
        "url": `https://k89bet68.com/${paths.recharge}`
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Hướng dẫn đăng ký K89Bet",
        "url": `https://k89bet68.com/${paths.register}`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": "Hướng dẫn tải app K89Bet",
        "url": `https://k89bet68.com/${paths.download}`
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": "Hướng dẫn rút tiền K89Bet",
        "url": `https://k89bet68.com/${paths.withdraw}`
      },
      {
        "@type": "ListItem",
        "position": 5,
        "name": "Khuyến mãi K89Bet",
        "url": `https://k89bet68.com/${paths.promotion}`
      }
    ]
  },
  "keywords": [
